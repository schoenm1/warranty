...
%																															|
\usepackage{float} 							%																					|
%Das Paket float unterstützt bei der Positionierung von Grafiken und Tabellen (innerhalb der figure- und table-Umgebungen).							|
%Normalerweise setzt LaTeX diese Elemente nach bestimmten Vorgaben relativ autonom, mit float ist eine exakte Angabe möglich.						|
% @option \begin{figure}[H]: Bild ganau HERE = [H] einsetzen																			|
% @option \includegraphics[height=\textheight, keepaspectratio=true]{gantt_chart.png}: keepascpectration = true: Ränder niche übernehmen				|
%																															|
...
\newcommand{\abkDef}[2]{\nomenclature{#1}{#2}\label{Abk.#1}{#1 (#2)} }
...
%INFO: changed 07.01.2013 / Micha
%hypertexnames=true, [vorher = false]
