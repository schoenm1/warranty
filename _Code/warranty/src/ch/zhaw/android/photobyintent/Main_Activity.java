...
public class Main_Activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button browseListButton = (Button) findViewById(R.id.btnIntendS);

		/**
		 * This Listener will open a new Activity
		 */
		browseListButton.setOnClickListener(new OnClickListener() {
