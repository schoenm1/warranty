...
\item \textcolor{red} {\(Vorschlag\) Fast alle Java- Klassen inklusive Unterstützung für SSL, HTTP, JSON und XML stehen zur Verfügung}
...
Als Programmierer sollte beachtet werden, dass eine Beschriftung eines Buttons nicht hardcoded wird, da die Flexibilität und die lose Kopplung verloren gehen. Wird stattdessen auf die Variable in der strings.xml Datei verwiesen, können alle App-Texte zentral verwaltet werden.\\
Ist dies einmal gegeben, ist ein Hinzufügen einer weiteren Sprache kein Problem mehr.
Defaultmässig liegt die strings.xml Datei im Verzeichnis ../res/values/ und definiert die englische Sprache.\\
...
\begin{itemize}
\item enthält wichtige Informationen, damit die App auf einem System ausführbar ist
...
\item Voraussetzungen für den Betrieb \\ z.B. nötige Bibliotheken
