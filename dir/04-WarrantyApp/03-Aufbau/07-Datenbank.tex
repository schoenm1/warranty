...
Da die Anzahl der Datentypen in SQLite auf NULL, INTEGER, REAL, TEXT und BLOB beschränkt ist\footnote{gemäss \url{http://www.sqlite.org/datatype3.html}}, ist das Datenbankschema von Warranty schnell definiert.
...
Da SQLite keine Datentypen für Datum und Zeit zur Verfügung stellt, wir aber trotzdem Datumsstempel benötigen, greifen wir auf den Datentyp TEXT und Datumsfunktionen wie ``date''\footnote{gemäss \url{http://www.sqlite.org/lang_datefunc.html}} von SQLite zurück.
