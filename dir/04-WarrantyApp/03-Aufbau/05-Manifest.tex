...
Nebst dem Zugriff auf den Speicher bedient sich Warranty den Kamerafunktionalitäten. \index{Kamera} Da diese ebenfalls explizit erlaubt werden müssen, wird das entsprechende Recht im Manifest.xml hinterlegt.
